...
public class Assignment6Q3 {
	public static void main(String[] args) {
		...
		if (choice.equalsIgnoreCase("a")) {
			...
			Employee E1 = new Employee(1, "Rajesh", "Ece", 10000);
			Employee E2 = new Employee(2, "Kumar", "Mec", 25000);
			...
			Employee E7 = new Employee(7, "Nishanth", "MarvelC", 2000000);
			Employee E8 = new Employee(8, "Niteesh", "MarvelI", 2000100);
			Employee E9 = new Employee(9, "Mahesh", "MarvelB", 210000);
			Employee E10 = new Employee(10, "Naresh", "MarvelS", 300000);
