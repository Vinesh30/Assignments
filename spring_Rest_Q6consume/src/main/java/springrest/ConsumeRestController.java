...
public class ConsumeRestController {
	...
	public int add(@PathVariable int a, @PathVariable int b) {
		String uri = "http://localhost:8080/springrest.Q6/add/" + a + "/" + b;
	...
	public int subtract(@PathVariable int a, @PathVariable int b) {
		String uri = "http://localhost:8080/springrest.Q6/subtract/" + a + "/" + b;
		int res = restTemplate.getForObject(uri, Integer.class);
		return res;
	}
	...
	public int multiply(@PathVariable int a, @PathVariable int b) {
		String uri = "http://localhost:8080/springrest.Q6/multiply/" + a + "/" + b;
		int res = restTemplate.getForObject(uri, Integer.class);
		return res;
	}
	...
	public double division(@PathVariable int a, @PathVariable int b) {
		String uri = "http://localhost:8080/springrest.Q6/divide/" + a + "/" + b;
	...
	public double squareRoot(@PathVariable int a) {
		String uri = "http://localhost:8080/springrest.Q6/sqrt/" + a;
		double res = restTemplate.getForObject(uri, Double.class);
		return res;
	}
